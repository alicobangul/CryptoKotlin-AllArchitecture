package com.basesoftware.cryptokotlin.architecture.mvp.model
...
@ActivityScoped
class MVPRepository @Inject constructor(private var cryptoAPI : CryptoAPI, private var cryptoDao : CryptoDao, private var compositeDisposable : CompositeDisposable) {
    ...
    fun checkDataFromDb() {
        ...
        compositeDisposable.add(
            ...
            .subscribe { t: List<CryptoModel> -> behaviorDataFromDb.onNext(t) }
